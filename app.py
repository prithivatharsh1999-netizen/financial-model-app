...
# 2. INVISIBLE API AUTHENTICATION (Using Streamlit Secrets)
try:
    # This pulls the key directly from the Streamlit server securely
    ...
    st.error("The API Key is missing! Please add it to your Streamlit App Secrets.")
